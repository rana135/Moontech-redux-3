...
const ProductCard = ({ product }) => {
  ...
  return (
    <div
      ...
      key={product._id}
    >
      {pathname.includes("cart") && <div className="bg-indigo-500 absolute h-8 w-8 grid place-items-center text-white rounded-full">
      ...
      <div className='flex gap-2 mt-5'>
        ...
        className='bg-indigo-500 justify-between items-center flex w-full rounded-full py-1 px-2 text-white text-bold'>
          <p>REMOVE</p>
          <MdDelete size={20}/>
        </button>}
